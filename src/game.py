    ...
    def draw_sos_list(self) -> None:
        for sos in self.board.sos_list:
            ...
            draw_nice_line(self.surface,
                           ...
                           #[self.board_offset[idx] + (v + 0.5) * self.cell_size + (v + 1) * self.gap_size for key, v in sos.p1.items()], 
                           #[self.board_offset[idx] + (v + 0.5) * self.cell_size + (v + 1) * self.gap_size for key, v in sos.p2.items()],
